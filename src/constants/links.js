export const links = [
    {
        answers: [true, 'Broker', true, 'SSN', undefined, undefined, undefined, undefined, 'Colonial Life', true],
        link: "https://pangea.geninfo.com/Unum/Apply/Default.aspx?BY29ChRPFpBBkxv9SZexjQ=="
    },
    {
        answers: [true, 'Broker', true, 'SSN', undefined, undefined, undefined, undefined, 'Independent Broker', undefined],
        link: "https://pangea.geninfo.com/Unum/Apply/Default.aspx?BY29ChRPFpBLKyf5AhE8IQ=="
    },
    {
        answers: [true, 'Broker', true, 'SSN', undefined, undefined, undefined, undefined, 'NY Life', undefined],
    ...
    {
        answers: [true, 'Broker', true, 'Tax ID', "Agency, Brokerage Firm, or Company", true, "Independent Company", undefined, undefined, undefined],
