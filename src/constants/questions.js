export const questions = [
    'Do you currently have an active license to sell accident, health or life insurance?',
    'What is your role in selling Unum products? Please select the applicable field.',
    {
    ...
    'Will Unum pay compensation to your SSN or to a Company Tax ID?',
    'Are you on boarding with Unum as an Individual Broker or wanting to setup an Agency/Brokerage Firm/Company?',
    ...
    'If you plan to sell Unum business through one of the following entities, please select the applicable entity.',
    'By selecting Colonial Life, I hereby certify that my Agency, Brokerage Firm, or Company previously completed their onboarding process and am recognized as a Colonial Life agent.',
    'If you plan to sell Unum business through one of the following entities, please select the applicable entity. Otherwise select the Independent option listed.',
    'By selecting Colonial Life, I hereby certify that I have previously completed their onboarding process and am recognized as a Colonial Life agent.'
];