export const questions = {
    Q1: 'Do you currently have an active license to sell accident, health or life insurance?',
    Q2: 'What is your role in selling Unum products? Please select the applicable field.',
    Q3: {
    ...
    Q9: 'If you plan to sell Unum business through one of the following entities, please select the applicable entity. Otherwise select the Independent option listed.',
    Q10: 'By selecting Colonial Life, I hereby certify that I have previously completed their onboarding process and am recognized as a Colonial Life agent.'
};